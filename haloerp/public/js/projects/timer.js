frappe.provide("haloerp.timesheet");

haloerp.timesheet.timer = function (frm, row, timestamp = 0) {
	...
	haloerp.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

haloerp.timesheet.control_timer = function (frm, dialog, row, timestamp = 0) {
