...
from haloerp.crm.doctype.appointment.appointment import (
	Appointment,
...
from haloerp.www.book_appointment.index import create_appointment, get_appointment_slots
from haloerp.www.book_appointment.verify import index as verify_index
