...
from haloerp.accounts.party import validate_party_frozen_disabled
from haloerp.crm.utils import (
	CRMNote,
	copy_comments,
	link_communications,
	link_open_events,
...
class Opportunity(TransactionBase, CRMNote):
	...
	if TYPE_CHECKING:
		...
		from haloerp.crm.doctype.crm_note.crm_note import CRMNote
		from haloerp.crm.doctype.opportunity_item.opportunity_item import OpportunityItem
		from haloerp.crm.doctype.opportunity_lost_reason_detail.opportunity_lost_reason_detail import (
