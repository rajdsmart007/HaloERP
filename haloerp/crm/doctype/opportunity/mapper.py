...
def make_quotation(source_name: str, target_doc: str | dict | Document | None = None):
	def set_missing_values(source, target):
		from haloerp.controllers.accounts_controller import get_default_taxes_and_charges
...
def make_opportunity_from_communication(
	...
	from haloerp.crm.doctype.lead.mapper import make_lead_from_communication
