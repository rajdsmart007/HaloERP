...
class TestStockUtilities(ERPNextTestSuite, StockTestMixin):
	...
	def test_get_latest_stock_qty(self):
		...
		from haloerp.stock.utils import get_latest_stock_qty
	...
	def test_get_stock_value_from_bin(self):
		...
		from haloerp.stock.doctype.stock_entry.stock_entry_utils import make_stock_entry
		from haloerp.stock.utils import get_stock_value_from_bin
	...
	def test_get_avg_purchase_rate(self):
		...
		from haloerp.stock.utils import get_avg_purchase_rate
