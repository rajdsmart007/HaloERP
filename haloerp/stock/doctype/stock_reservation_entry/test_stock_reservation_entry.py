...
from haloerp.selling.doctype.sales_order.mapper import create_pick_list, make_delivery_note
...
from haloerp.stock.doctype.stock_entry.stock_entry import StockEntry
