...
from haloerp.stock.utils import get_combine_datetime, get_or_make_bin, get_stock_balance
...
class StockReservationEntry(Document):
	...
	def auto_reserve_serial_and_batch(self, based_on: str | None = None) -> None:
		...
		if (
			...
			from haloerp.stock.serial_batch_bundle import get_serial_nos_batch
...
def create_stock_reservation_entries_for_so_items(
	...
	from haloerp.selling.doctype.sales_order.services.reservation import get_unreserved_qty
