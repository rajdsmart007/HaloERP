...
class TestSerialandBatchBundle(ERPNextTestSuite):
	...
	def test_get_picked_batches_runs(self):
		from haloerp.stock.doctype.serial_and_batch_bundle.serial_and_batch_bundle import get_picked_batches
...
def get_batch_from_bundle(bundle):
	from haloerp.stock.serial_batch_bundle import get_batch_nos
...
def get_serial_nos_from_bundle(bundle):
	from haloerp.stock.serial_batch_bundle import get_serial_nos
