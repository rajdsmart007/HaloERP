...
from haloerp.selling.doctype.sales_order.mapper import create_pick_list
...
from haloerp.stock.doctype.packed_item.test_packed_item import create_product_bundle
from haloerp.stock.doctype.pick_list.mapper import (
	create_delivery,
...
class TestPickList(ERPNextTestSuite):
	...
	def test_get_stock_availability(self):
		from haloerp.stock.doctype.pick_list.pick_list import get_stock_availability
	...
	def test_pick_list_warehouse_validation(self):
		...
		from haloerp.stock.doctype.pick_list.pick_list import (
	...
	def test_multiple_pick_lists_delivery_note(self):
		from haloerp.stock.doctype.pick_list.mapper import create_dn_for_pick_lists
	...
	def test_creating_dn_from_so_with_different_addresses(self):
		...
		map_docs(
			"haloerp.selling.doctype.sales_order.mapper.create_pick_list",
	...
	def test_get_pick_list_query_postgres_valid(self):
		...
		from haloerp.stock.doctype.pick_list.pick_list import get_pick_list_query
