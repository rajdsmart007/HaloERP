...
class TestBatch(ERPNextTestSuite):
	...
	def test_batch_qty_on_pos_creation(self):
		from haloerp.accounts.doctype.pos_closing_entry.test_pos_closing_entry import (
			init_user_and_profile,
		)
		from haloerp.accounts.doctype.pos_invoice.test_pos_invoice import create_pos_invoice
	...
	def test_batch_split(self):
		...
		from haloerp.stock.doctype.batch.batch import split_batch
	...
	def test_get_batch_no_search_returns_batches(self):
		...
		"""
		from haloerp.controllers.queries import (
			get_batch_no,
