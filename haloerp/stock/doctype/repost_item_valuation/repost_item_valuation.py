...
import haloerp
from haloerp.accounts.services.gl_validator import validate_accounting_period
from haloerp.accounts.utils import get_future_stock_vouchers, repost_gle_for_stock_vouchers
from haloerp.stock.stock_ledger import (
...
from haloerp.utilities import clear_logs_with_references
...
def repost_gl_entries(doc):
	if not cint(haloerp.is_perpetual_inventory_enabled(doc.company)):
		return
...
def execute_repost_item_valuation():
	...
	method = "haloerp.stock.doctype.repost_item_valuation.repost_item_valuation.repost_entries"
	if frappe.db.get_single_value("Stock Reposting Settings", "enable_parallel_reposting"):
		method = "haloerp.stock.doctype.repost_item_valuation.repost_item_valuation.run_parallel_reposting"
