...
from haloerp.stock.doctype.quality_inspection_template.quality_inspection_template import (
	get_template_details,
)
from haloerp.stock.services.quality_inspection_service import (
...
class QualityInspection(Document):
	...
	if TYPE_CHECKING:
		...
		from haloerp.stock.doctype.quality_inspection_reading.quality_inspection_reading import (
