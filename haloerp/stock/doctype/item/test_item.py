...
class TestItem(ERPNextTestSuite):
	...
	def test_check_stock_uom_with_bin_no_sle(self):
		from haloerp.stock.stock_balance import update_bin_qty
	...
	def test_item_dashboard(self):
		from haloerp.stock.dashboard.item_dashboard import get_data
	...
	def test_search_fields_for_item(self):
		from haloerp.controllers.queries import item_query
