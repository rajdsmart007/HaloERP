...
from haloerp.stock.doctype.item_attribute.item_attribute import ItemAttributeIncrementError
...
class TestItemAttribute(ERPNextTestSuite):
	...
	def test_validate_existing_items_finds_variants(self):
		...
		from haloerp.controllers.item_variant import InvalidItemAttributeValueError, create_variant
