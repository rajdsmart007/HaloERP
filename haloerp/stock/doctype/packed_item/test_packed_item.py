...
class TestPackedItem(ERPNextTestSuite):
	...
	def test_backfill_patch_stamps_existing_rows(self):
		...
		from haloerp.patches.v16_0.submit_existing_product_bundles import (
	...
	def test_choosing_an_older_version_packs_its_components(self):
		...
		from haloerp.selling.doctype.product_bundle.product_bundle import (
	...
	def test_get_items_from_product_bundle_endpoint(self):
		...
		from haloerp.selling.doctype.product_bundle.product_bundle import get_active_product_bundle
		from haloerp.stock.doctype.packed_item.packed_item import get_items_from_product_bundle
