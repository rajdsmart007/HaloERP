...
from haloerp.stock.doctype.delivery_note.services.billing_status import BillingStatusService
...
class DeliveryNote(SellingController):
	...
	if TYPE_CHECKING:
		...
		from haloerp.stock.doctype.delivery_note_item.delivery_note_item import DeliveryNoteItem
	...
	def get_gl_entries(self, inventory_account_map=None):
		from haloerp.stock.doctype.delivery_note.services.gl_composer import DeliveryNoteGLComposer
