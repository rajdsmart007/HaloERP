...
from haloerp.stock.doctype.item_alternative.item_alternative import get_alternative_items
...
class TestItemAlternative(ERPNextTestSuite):
	...
	def test_get_used_alternative_items_returns_substitution(self):
		...
		from haloerp.stock.doctype.stock_entry.stock_entry import get_used_alternative_items
