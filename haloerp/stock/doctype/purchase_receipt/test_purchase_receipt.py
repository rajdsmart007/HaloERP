...
import haloerp
import haloerp.controllers
import haloerp.controllers.status_updater
from haloerp.accounts.doctype.account.test_account import get_inventory_account
from haloerp.buying.doctype.supplier.test_supplier import create_supplier
from haloerp.controllers.accounts_controller import InvalidQtyError
from haloerp.controllers.buying_controller import QtyMismatchError
from haloerp.stock import get_warehouse_account_map
from haloerp.stock.doctype.item.test_item import create_item, make_item, make_uom_conversion_factor
from haloerp.stock.doctype.material_request.mapper import make_purchase_order
from haloerp.stock.doctype.purchase_receipt.mapper import make_purchase_invoice
from haloerp.stock.doctype.serial_and_batch_bundle.serial_and_batch_bundle import (
...
from haloerp.stock.doctype.warehouse.test_warehouse import create_warehouse
from haloerp.stock.get_item_details import get_conversion_factor
...
class TestPurchaseReceipt(ERPNextTestSuite):
	...
	def test_make_purchase_invoice(self):
		from haloerp.accounts.doctype.payment_entry.test_payment_entry import create_payment_term
	...
	def test_make_purchase_invoice_with_dict_target(self):
		...
		pi = map_docs(
			method="haloerp.stock.doctype.purchase_receipt.mapper.make_purchase_invoice",
	...
	def test_purchase_receipt_no_gl_entry(self):
		from haloerp.stock.doctype.stock_entry.test_stock_entry import make_stock_entry
	...
	def test_purchase_receipt_gl_entry(self):
		...
		self.assertEqual(cint(haloerp.is_perpetual_inventory_enabled(pr.company)), 1)
	...
	def test_purchase_return_for_rejected_qty(self):
		from haloerp.stock.doctype.warehouse.test_warehouse import get_warehouse
	...
	def test_closed_purchase_receipt(self):
		from haloerp.stock.doctype.purchase_receipt.purchase_receipt import (
	...
	def test_purchase_return_against_closed_purchase_order(self):
		from haloerp.buying.doctype.purchase_order.mapper import make_purchase_receipt as make_pr_from_po
		from haloerp.buying.doctype.purchase_order.test_purchase_order import create_purchase_order
		from haloerp.controllers.sales_and_purchase_return import make_return_doc
	...
	def test_pr_billing_status(self):
		...
		3. PO -> PR2.
		"""
		from haloerp.buying.doctype.purchase_order.mapper import (
			make_purchase_invoice as make_purchase_invoice_from_po,
		)
		from haloerp.buying.doctype.purchase_order.mapper import make_purchase_receipt
		from haloerp.buying.doctype.purchase_order.test_purchase_order import create_purchase_order
	...
	def test_pr_billing_status_for_po_invoice_across_multiple_receipts(self):
		...
		from haloerp.patches.v16_0 import recalculate_purchase_receipt_billing_status
	...
	def test_billing_repair_patch_skips_invoice_created_receipts(self):
		...
		"""
		from haloerp.accounts.doctype.purchase_invoice.mapper import (
	...
	def test_pr_billing_status_with_mixed_direct_and_po_invoice(self):
		...
		from haloerp.patches.v16_0 import recalculate_mixed_purchase_receipt_billing_status
	...
	def test_purchase_return_with_submitted_asset(self):
		from haloerp.stock.doctype.purchase_receipt.mapper import make_purchase_return
	...
	def test_make_purchase_invoice_from_pr_for_returned_qty(self):
		from haloerp.buying.doctype.purchase_order.test_purchase_order import (
	...
	def test_stock_transfer_from_purchase_receipt(self):
		from haloerp.stock.doctype.delivery_note.mapper import make_inter_company_purchase_receipt
		from haloerp.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
	...
	def test_lcv_for_internal_transfer(self):
		from haloerp.stock.doctype.delivery_note.mapper import make_inter_company_purchase_receipt
		from haloerp.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
		from haloerp.stock.doctype.landed_cost_voucher.test_landed_cost_voucher import (
	...
	def test_stock_transfer_from_purchase_receipt_with_valuation(self):
		...
		from haloerp.stock.get_item_details import get_valuation_rate
		from haloerp.stock.utils import get_stock_balance
	...
	def test_po_to_pi_and_po_to_pr_worflow_full(self):
		...
		"""
		from haloerp.buying.doctype.purchase_order import mapper as purchase_order
		from haloerp.buying.doctype.purchase_order import test_purchase_order
	...
	def test_purchase_receipt_with_exchange_rate_difference(self):
		...
		from haloerp.accounts.party import add_party_account
	...
	def test_payment_terms_are_fetched_when_creating_purchase_invoice(self):
		from haloerp.accounts.doctype.payment_entry.test_payment_entry import (
			create_payment_terms_template,
		)
		from haloerp.accounts.doctype.purchase_invoice.test_purchase_invoice import make_purchase_invoice
		from haloerp.buying.doctype.purchase_order.test_purchase_order import (
			create_purchase_order,
			make_pr_against_po,
		)
		from haloerp.selling.doctype.sales_order.test_sales_order import (
	...
	def test_neg_to_positive(self):
		from haloerp.stock.doctype.stock_entry.stock_entry_utils import make_stock_entry
	...
	def test_internal_transfer_pr_incoming_sle_anchored_to_dn_rate(self):
		...
		from haloerp.stock.doctype.delivery_note.mapper import make_inter_company_purchase_receipt
		from haloerp.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
		from haloerp.stock.stock_ledger import update_entries_after
	...
	def test_backdated_transaction_for_internal_transfer_in_trasit_warehouse_for_purchase_invoice(
		...
		from haloerp.accounts.doctype.sales_invoice.mapper import (
	...
	def test_disable_last_purchase_rate(self):
		from haloerp.stock.get_item_details import get_item_details
	...
	def test_return_from_rejected_warehouse(self):
		from haloerp.stock.doctype.purchase_receipt.mapper import (
	...
	def test_use_serial_batch_fields_for_serial_nos(self):
		from haloerp.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
		from haloerp.stock.doctype.serial_no.serial_no import get_serial_nos
		from haloerp.stock.doctype.stock_reconciliation.test_stock_reconciliation import (
			create_stock_reconciliation,
		)
	...
	def test_pr_billed_amount_against_return_entry(self):
		from haloerp.accounts.doctype.purchase_invoice.mapper import make_debit_note
		from haloerp.stock.doctype.purchase_receipt.mapper import (
	...
	def test_valuation_taxes_lcv_repost_after_billing(self):
		...
		old_perpetual_inventory = haloerp.is_perpetual_inventory_enabled("_Test Company")
	...
	def test_sles_with_same_posting_datetime_and_creation(self):
		from haloerp.stock.doctype.stock_entry.test_stock_entry import make_stock_entry
		from haloerp.stock.report.stock_balance.stock_balance import execute
	...
	def test_internal_pr_qty_change_only_single_batch(self):
		...
		self.assertRaises(haloerp.controllers.status_updater.OverAllowanceError, pr.submit)
	...
	def test_multiple_transactions_with_same_posting_datetime(self):
		from haloerp.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
		from haloerp.stock.stock_ledger import NegativeStockError
	...
	def test_purchase_receipt_gl_entries_for_asset_item(self):
		from haloerp.assets.doctype.asset.test_asset import create_fixed_asset_item
...
def prepare_data_for_internal_transfer():
	from haloerp.accounts.doctype.sales_invoice.test_sales_invoice import create_internal_supplier
