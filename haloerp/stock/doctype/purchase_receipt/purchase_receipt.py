...
from haloerp.stock.doctype.purchase_receipt.services.billing_status import BillingStatusService
from haloerp.stock.doctype.purchase_receipt.services.provisional_accounting import (
	ProvisionalAccountingService,
)
from haloerp.stock.doctype.purchase_receipt.services.reservation import (
...
class PurchaseReceipt(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from haloerp.stock.doctype.purchase_receipt_item.purchase_receipt_item import PurchaseReceiptItem
	...
	def get_gl_entries(self, inventory_account_map=None, via_landed_cost_voucher=False):
		from haloerp.stock.doctype.purchase_receipt.services.gl_composer import (
