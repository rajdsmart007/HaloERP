...
from haloerp.controllers.item_variant import ItemTemplateCannotHaveStock
from haloerp.stock.doctype.inventory_dimension.inventory_dimension import get_inventory_dimensions
from haloerp.stock.serial_batch_bundle import SerialBatchBundle
...
class StockLedgerEntry(Document):
	...
	def is_standard_cost_revaluation(self):
		...
		from haloerp.stock.doctype.stock_reconciliation.stock_reconciliation import is_standard_cost_item
	...
	def validate_and_set_fiscal_year(self):
		if not self.fiscal_year:
			...
			from haloerp.accounts.utils import validate_fiscal_year
	...
	def block_transactions_against_group_warehouse(self):
		from haloerp.stock.utils import is_group_warehouse
