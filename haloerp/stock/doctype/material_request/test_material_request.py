...
# ERPNext - web based ERP (http://haloerp.com)
...
from haloerp.stock.doctype.material_request.material_request import (
	raise_work_orders,
)
from haloerp.stock.doctype.stock_entry.stock_entry import make_stock_in_entry
...
class TestMaterialRequest(ERPNextTestSuite):
	...
	def test_partial_make_stock_entry(self):
		from haloerp.stock.doctype.stock_entry.stock_entry_utils import make_stock_entry as _make_stock_entry
	...
	def test_auto_email_users_with_company_user_permissions(self):
		from haloerp.stock.reorder_item import get_email_list
	...
	def test_get_remaining_qty_from_sales_order(self):
		...
		from haloerp.selling.doctype.sales_order.mapper import make_material_request
		from haloerp.selling.doctype.sales_order.test_sales_order import make_sales_order
	...
	def test_get_item_default_suppliers(self):
		from haloerp.stock.doctype.material_request.mapper import get_item_default_suppliers
	...
	def test_make_purchase_orders_by_supplier(self):
		from haloerp.stock.doctype.material_request.mapper import make_purchase_orders_by_supplier
