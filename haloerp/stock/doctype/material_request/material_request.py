...
from haloerp.buying.utils import check_on_hold_or_closed_status, validate_for_items
from haloerp.controllers.buying_controller import BuyingController
from haloerp.manufacturing.doctype.work_order.work_order import get_item_details
from haloerp.stock.get_item_details import get_price_list_rate_for
from haloerp.stock.stock_balance import get_indented_qty, update_bin_qty
...
class MaterialRequest(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from haloerp.stock.doctype.material_request_item.material_request_item import MaterialRequestItem
	...
	def validate(self):
		...
		from haloerp.controllers.status_updater import validate_status
