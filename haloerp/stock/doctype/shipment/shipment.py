...
class Shipment(Document):
	...
	if TYPE_CHECKING:
		...
		from haloerp.stock.doctype.shipment_delivery_note.shipment_delivery_note import ShipmentDeliveryNote
		from haloerp.stock.doctype.shipment_parcel.shipment_parcel import ShipmentParcel
