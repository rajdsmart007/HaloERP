...
import haloerp
from haloerp.buying.utils import check_on_hold_or_closed_status
from haloerp.controllers.taxes_and_totals import init_landed_taxes_and_totals
from haloerp.manufacturing.doctype.bom.bom import (
...
from haloerp.stock.stock_ledger import get_previous_sle, get_valuation_rate
from haloerp.stock.utils import get_incoming_rate
...
from haloerp.controllers.subcontracting_inward_controller import SubcontractingInwardController
...
class StockEntry(StockController, SubcontractingInwardController):
	...
	if TYPE_CHECKING:
		...
		from haloerp.stock.doctype.landed_cost_taxes_and_charges.landed_cost_taxes_and_charges import (
			LandedCostTaxesandCharges,
		)
		from haloerp.stock.doctype.stock_entry_detail.stock_entry_detail import StockEntryDetail
	...
	def before_validate(self):
		from haloerp.stock.doctype.putaway_rule.putaway_rule import apply_putaway_rule
	...
	def _set_incoming_item_rate(
		...
		if not d.basic_rate and not d.allow_zero_valuation_rate and not has_derived_rate:
			d.basic_rate = get_valuation_rate(
				...
				currency=haloerp.get_company_currency(self.company),
				company=self.company,
	...
	def get_gl_entries(self, inventory_account_map):
		from haloerp.stock.doctype.stock_entry.services.gl_composer import StockEntryGLComposer
	...
	def make_stock_reserve_for_wip_and_fg(self):
		from haloerp.manufacturing.doctype.work_order.services.reservation import (
	...
	def get_bom_raw_materials(self, qty):
		from haloerp.manufacturing.doctype.bom.bom import get_bom_items_as_dict
	...
	def update_pick_list_status(self):
		from haloerp.stock.doctype.pick_list.pick_list import update_pick_list_status
