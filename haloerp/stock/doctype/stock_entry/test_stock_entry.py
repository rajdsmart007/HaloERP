...
from haloerp.exceptions import QualityInspectionRequiredError
from haloerp.stock.doctype.item.test_item import (
	create_item,
	make_item,
	make_item_variant,
	set_item_variant_settings,
)
from haloerp.stock.doctype.material_request.mapper import (
	make_in_transit_stock_entry,
)
from haloerp.stock.doctype.material_request.test_material_request import (
...
from haloerp.stock.doctype.serial_no.serial_no import *
from haloerp.stock.doctype.stock_entry.stock_entry import (
...
from haloerp.stock.doctype.stock_ledger_entry.stock_ledger_entry import StockFreezeError
from haloerp.stock.doctype.stock_reconciliation.stock_reconciliation import (
	OpeningEntryAccountError,
)
from haloerp.stock.doctype.stock_reconciliation.test_stock_reconciliation import (
	create_stock_reconciliation,
)
from haloerp.stock.stock_ledger import NegativeStockError, get_previous_sle
...
class TestStockEntry(ERPNextTestSuite):
	...
	def _test_auto_material_request(
		...
		from haloerp.stock.reorder_item import reorder_item
	...
	def test_serial_batch_item_stock_entry(self):
		...
		"""
		from haloerp.stock.doctype.batch.batch import get_batch_qty
	...
	def test_warehouse_company_validation(self):
		...
		with self.set_user("test2@example.com"):
			from haloerp.stock.utils import InvalidWarehouseCompany
	...
	def test_work_order(self):
		from haloerp.manufacturing.doctype.work_order.mapper import (
	...
	def test_material_transfer_for_manufacture_qty_precision(self):
		from haloerp.stock.doctype.stock_entry.services.material_transfer import (
	...
	def test_tracked_consumption_deducts_matching_attribution_bucket(self):
		from haloerp.stock.doctype.stock_entry.services.manufacturing import ManufactureStockEntry
	...
	def test_variant_work_order(self):
		...
		from haloerp.manufacturing.doctype.work_order.mapper import make_stock_entry
	...
	def test_check_item_quality_inspection_returns_items_for_stock_entry(self):
		from haloerp.controllers.stock_controller import check_item_quality_inspection
	...
	def test_quality_inspection_across_stock_entry_purposes(self):
		from haloerp.controllers.stock_controller import check_item_quality_inspection
		from haloerp.exceptions import QualityInspectionRejectedError, QualityInspectionRequiredError
		from haloerp.stock.doctype.quality_inspection.test_quality_inspection import (
	...
	def test_duplicate_entry_for_work_order(self):
		...
		from haloerp.manufacturing.doctype.work_order.test_work_order import make_wo_order_test_record
	...
	def test_quality_inspection_required_for_send_to_subcontractor(self):
		from haloerp.controllers.subcontracting_controller import make_rm_stock_entry
		from haloerp.controllers.tests.test_subcontracting_controller import (
	...
	def test_quality_inspection_required_for_disassemble(self):
		from haloerp.exceptions import QualityInspectionRejectedError, QualityInspectionRequiredError
		from haloerp.manufacturing.doctype.production_plan.test_production_plan import make_bom
		from haloerp.manufacturing.doctype.work_order.mapper import (
			make_stock_entry as make_wo_stock_entry,
		)
		from haloerp.manufacturing.doctype.work_order.test_work_order import make_wo_order_test_record
	...
	def test_future_negative_sle_batch(self):
		from haloerp.stock.doctype.batch.test_batch import TestBatch
	...
	def test_mapped_stock_entry(self):
		...
		from haloerp.stock.doctype.purchase_receipt.mapper import make_stock_entry
	...
	def test_reposting_for_depedent_warehouse(self):
		from haloerp.stock.doctype.repost_item_valuation.repost_item_valuation import repost_sl_entries
		from haloerp.stock.doctype.warehouse.test_warehouse import create_warehouse
	...
	def test_batch_expiry(self):
		from haloerp.controllers.stock_controller import BatchExpiredError
		from haloerp.stock.doctype.batch.test_batch import make_new_batch
	...
	def test_secondary_item_with_zero_cost_allocation_carries_no_value(self):
		...
		from haloerp.manufacturing.doctype.work_order.test_work_order import make_wo_order_test_record
		from haloerp.manufacturing.doctype.work_order.work_order import (
	...
	def test_sample_retention_stock_entry(self):
		from haloerp.stock.doctype.stock_entry.services.manufacturing import (
	...
	def test_validation_as_per_bom_with_continuous_raw_material_consumption(self):
		from haloerp.manufacturing.doctype.production_plan.test_production_plan import make_bom
		from haloerp.manufacturing.doctype.work_order.mapper import make_stock_entry as _make_stock_entry
		from haloerp.manufacturing.doctype.work_order.work_order import make_work_order
	...
	def test_qi_creation_with_naming_rule_company_condition(self):
		...
		"""
		from haloerp.controllers.stock_controller import make_quality_inspections
		from haloerp.stock.doctype.warehouse.test_warehouse import create_warehouse
...
class TestStockEntryCoverage(ERPNextTestSuite):
	...
	def test_get_uom_details_returns_conversion_factor_and_transfer_qty(self):
		from haloerp.stock.doctype.stock_entry.stock_entry import get_uom_details
	...
	def test_get_warehouse_details_returns_actual_qty_and_rate(self):
		...
		from haloerp.stock.doctype.stock_entry.stock_entry import get_warehouse_details
	...
	def test_get_work_order_details_returns_correct_fields(self):
		from haloerp.stock.doctype.stock_entry.stock_entry import get_work_order_details
	...
	def test_get_bom_items_returns_raw_materials_with_structure(self):
		from haloerp.stock.doctype.stock_entry.services.manufacturing import get_bom_items
	...
	def test_get_expired_batches_includes_expired_batch(self):
		from haloerp.stock.doctype.batch.test_batch import make_new_batch
		from haloerp.stock.doctype.stock_entry.services.serial_batch import (
			get_expired_batches,
		)
	...
	def test_get_available_materials_tracks_transferred_qty(self):
		...
		from haloerp.stock.doctype.stock_entry.services.disassemble import (
			get_available_materials,
		)
	...
	def test_validate_fg_resets_invalid_serial_no_on_manufacture(self):
		from haloerp.manufacturing.doctype.bom.test_bom import create_nested_bom
		from haloerp.manufacturing.doctype.work_order.mapper import (
			make_stock_entry as _make_stock_entry,
		)
		from haloerp.manufacturing.doctype.work_order.test_work_order import make_wo_order_test_record
	...
	def test_validate_fg_resets_invalid_batch_no_on_manufacture(self):
		...
		from haloerp.manufacturing.doctype.work_order.test_work_order import make_wo_order_test_record
		from haloerp.stock.serial_batch_bundle import get_batches_from_bundle
...
def initialize_records_for_future_negative_sle_test(
	...
	from haloerp.stock.doctype.batch.test_batch import TestBatch, make_new_batch
	from haloerp.stock.doctype.stock_reconciliation.test_stock_reconciliation import (
		create_stock_reconciliation,
	)
	from haloerp.stock.doctype.warehouse.test_warehouse import create_warehouse
