...
from haloerp.manufacturing.doctype.job_card.job_card import OverlapError
from haloerp.manufacturing.doctype.production_plan.test_production_plan import (
	create_production_plan,
	make_bom,
)
from haloerp.manufacturing.doctype.work_order.test_work_order import make_operation, make_workstation
from haloerp.manufacturing.scheduling import loaders
from haloerp.manufacturing.scheduling.plan_adapter import apply_schedule, get_schedule_preview
...
class TestPlanAdapter(ERPNextTestSuite):
	...
	def test_incomplete_proposal_is_not_applied(self):
		...
		from haloerp.manufacturing.scheduling import plan_adapter
