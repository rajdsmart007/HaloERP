...
from haloerp.manufacturing.doctype.job_card.job_card import JobCardCancelError
from haloerp.manufacturing.doctype.job_card.mapper import make_stock_entry as make_stock_entry_from_jc
...
from haloerp.stock.doctype.item.test_item import create_item, make_item
...
from haloerp.stock.doctype.stock_entry import test_stock_entry
from haloerp.stock.doctype.stock_entry.stock_entry import OperationsNotCompleteError
from haloerp.stock.doctype.warehouse.test_warehouse import create_warehouse
from haloerp.stock.utils import get_bin
...
class TestWorkOrder(ERPNextTestSuite):
	...
	def test_wo_completion_with_pl_bom(self):
		from haloerp.manufacturing.doctype.bom.test_bom import (
	...
	def test_repair_material_transfer_precision_patch(self):
		from haloerp.patches.v16_0.repair_work_order_material_transfer import (
			execute,
	...
	def test_status_in_process_when_only_one_required_item_transferred(self):
		...
		from haloerp.manufacturing.doctype.work_order.mapper import create_pick_list
		from haloerp.stock.doctype.pick_list.mapper import create_stock_entry
	...
	def test_work_order_material_request_and_bom_details(self):
		from haloerp.stock.doctype.material_request.mapper import make_stock_entry as mr_to_stock_entry
	...
	def test_picked_qty_counts_pick_list_of_stopped_material_request(self):
		from haloerp.stock.doctype.material_request.mapper import create_pick_list as mr_to_pick_list
	...
	def test_disassembly_mixed_uom_rows_are_aggregated_in_stock_uom(self):
		...
		from haloerp.stock.doctype.stock_entry.services.disassemble import DisassembleStockEntry
		from haloerp.stock.doctype.stock_entry.test_stock_entry import (
			make_stock_entry as make_stock_entry_test_record,
		)
	...
	def test_disassembly_batch_tracked_items(self):
		from haloerp.stock.doctype.batch.batch import make_batch
		from haloerp.stock.doctype.stock_entry.test_stock_entry import (
			make_stock_entry as make_stock_entry_test_record,
		)
	...
	def test_stock_reservation_for_serialized_raw_material(self):
		from haloerp.stock.doctype.stock_entry.stock_entry_utils import (
			make_stock_entry as make_stock_entry_test_record,
		)
	...
	def test_send_to_subcontractor_can_consume_work_order_reserved_stock(self):
		from haloerp.buying.doctype.purchase_order.mapper import make_subcontracting_order
		from haloerp.controllers.subcontracting_controller import make_rm_stock_entry
		from haloerp.manufacturing.doctype.job_card.mapper import make_subcontracting_po
		from haloerp.stock.doctype.stock_entry.stock_entry_utils import (
			make_stock_entry as make_stock_entry_test_record,
		)
		from haloerp.stock.doctype.warehouse.test_warehouse import create_warehouse
	...
	def test_operations_time_planning_calculation(self):
		from haloerp.manufacturing.doctype.routing.test_routing import create_routing, setup_operations
	...
	def test_phantom_bom_explosion(self):
		from haloerp.manufacturing.doctype.bom.test_bom import create_tree_for_phantom_bom_tests
	...
	def test_transferred_qty_not_misattributed_between_item_and_its_substitute(self):
		...
		"""
		from haloerp.manufacturing.doctype.work_order.services.required_items import RequiredItemsService
...
def prepare_data_for_workstation_type_check():
	from haloerp.manufacturing.doctype.operation.test_operation import make_operation
	from haloerp.manufacturing.doctype.workstation.test_workstation import make_workstation
	from haloerp.manufacturing.doctype.workstation_type.test_workstation_type import (
