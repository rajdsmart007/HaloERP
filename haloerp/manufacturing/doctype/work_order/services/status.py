...
from haloerp.stock.stock_balance import get_planned_qty, update_bin_qty
...
class StatusService:
	...
	def _update_qty_for_purpose(self, purpose, fieldname):
		from haloerp.manufacturing.doctype.work_order.work_order import StockOverProductionError
	...
	def _update_produced_qty_in_so(self):
		from haloerp.selling.doctype.sales_order.sales_order import update_produced_qty_in_so_item
