...
from haloerp.manufacturing.doctype.work_order.services.operations import (
	OperationsService,
)
from haloerp.manufacturing.doctype.work_order.services.required_items import (
...
from haloerp.manufacturing.doctype.work_order.services.status import (
	StatusService,
)
...
from haloerp.stock.doctype.item.item import get_item_defaults, validate_end_of_life
from haloerp.stock.doctype.serial_no.serial_no import get_available_serial_nos
from haloerp.stock.utils import validate_warehouse_company
...
class WorkOrder(Document):
	...
	if TYPE_CHECKING:
		...
		from haloerp.manufacturing.doctype.work_order_additional_item.work_order_additional_item import (
			WorkOrderAdditionalItem,
		)
		from haloerp.manufacturing.doctype.work_order_item.work_order_item import WorkOrderItem
		from haloerp.manufacturing.doctype.work_order_operation.work_order_operation import WorkOrderOperation
