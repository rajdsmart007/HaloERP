...
from haloerp.manufacturing.doctype.production_plan.services.planning_queries import set_default_warehouses
...
class WorkOrderCreationService:
	...
	def make_work_order(self):
		from haloerp.manufacturing.doctype.work_order.work_order import get_default_warehouse
