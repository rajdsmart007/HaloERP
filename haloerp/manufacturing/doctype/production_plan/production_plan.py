...
from haloerp.manufacturing.doctype.bom.bom import validate_bom_no

# Backward-compatible re-exports (moved to mapper.py / services/).
from haloerp.manufacturing.doctype.production_plan.mapper import (
	get_so_details,
	sales_order_query,
)
...
from haloerp.manufacturing.doctype.production_plan.services.reservation import (
...
from haloerp.manufacturing.doctype.production_plan.services.sales_order_planning import (
	SalesOrderSourcingService,
)
from haloerp.manufacturing.doctype.production_plan.services.sub_assembly import (
	SubAssemblyService,
)
from haloerp.manufacturing.doctype.production_plan.services.work_order_planning import (
	WorkOrderCreationService,
)
from haloerp.stock.utils import get_or_make_bin
from haloerp.utilities.transaction_base import validate_uom_is_integer
...
class ProductionPlan(Document):
	...
	if TYPE_CHECKING:
		...
		from haloerp.manufacturing.doctype.material_request_plan_item.material_request_plan_item import (
			MaterialRequestPlanItem,
		)
		from haloerp.manufacturing.doctype.production_plan_item.production_plan_item import ProductionPlanItem
		from haloerp.manufacturing.doctype.production_plan_item_reference.production_plan_item_reference import (
			ProductionPlanItemReference,
		)
		from haloerp.manufacturing.doctype.production_plan_material_request.production_plan_material_request import (
			ProductionPlanMaterialRequest,
		)
		from haloerp.manufacturing.doctype.production_plan_material_request_warehouse.production_plan_material_request_warehouse import (
			ProductionPlanMaterialRequestWarehouse,
		)
		from haloerp.manufacturing.doctype.production_plan_sales_order.production_plan_sales_order import (
			ProductionPlanSalesOrder,
		)
		from haloerp.manufacturing.doctype.production_plan_sub_assembly_item.production_plan_sub_assembly_item import (
