...
from haloerp.manufacturing.doctype.job_card.job_card import (
	JobCardOverTransferError,
	OperationSequenceError,
	OverlapError,
)
from haloerp.manufacturing.doctype.job_card.mapper import (
...
from haloerp.manufacturing.doctype.work_order.work_order import WorkOrder, make_work_order
...
class TestJobCard(ERPNextTestSuite):
	...
	def test_if_corrective_jc_ops_cost_is_added_to_manufacture_stock_entry(self):
		...
		from haloerp.manufacturing.doctype.work_order.work_order import make_job_card
	...
	def test_job_card_material_request_and_bom_details(self):
		from haloerp.stock.doctype.material_request.mapper import make_stock_entry
	...
	def test_job_card_material_transfer_via_pick_list(self):
		from haloerp.stock.doctype.material_request.mapper import create_pick_list
	...
	def test_job_card_proccess_qty_and_completed_qty(self):
		from haloerp.manufacturing.doctype.routing.test_routing import (
			create_routing,
			setup_bom,
			setup_operations,
		)
	...
	def test_semi_fg_produced_qty_across_split_job_cards(self):
		from haloerp.manufacturing.doctype.operation.test_operation import make_operation
		from haloerp.manufacturing.doctype.work_order.mapper import make_job_card
		from haloerp.stock.doctype.item.test_item import make_item
