...
from haloerp.controllers.stock_controller import (
...
from haloerp.manufacturing.doctype.manufacturing_settings.manufacturing_settings import (
	get_mins_between_operations,
)
from haloerp.manufacturing.doctype.workstation_type.workstation_type import get_workstations
from haloerp.subcontracting.doctype.subcontracting_bom.subcontracting_bom import (
...
class JobCard(Document):
	...
	if TYPE_CHECKING:
		...
		from haloerp.manufacturing.doctype.job_card_item.job_card_item import JobCardItem
		from haloerp.manufacturing.doctype.job_card_operation.job_card_operation import JobCardOperation
		from haloerp.manufacturing.doctype.job_card_scheduled_time.job_card_scheduled_time import (
			JobCardScheduledTime,
		)
		from haloerp.manufacturing.doctype.job_card_secondary_item.job_card_secondary_item import (
			JobCardSecondaryItem,
		)
		from haloerp.manufacturing.doctype.job_card_time_log.job_card_time_log import JobCardTimeLog
	...
	def build_manufacture_stock_entry(self):
		from haloerp.stock.doctype.stock_entry_type.stock_entry_type import ManufactureEntry
