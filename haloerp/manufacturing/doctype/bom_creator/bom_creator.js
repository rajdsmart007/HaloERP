...
haloerp.bom.BomConfigurator = class BomConfigurator extends haloerp.TransactionController {
...
extend_cscript(cur_frm.cscript, new haloerp.bom.BomConfigurator({ frm: cur_frm }));
