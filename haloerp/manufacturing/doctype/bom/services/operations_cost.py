...
def _add_operation_workstation_costs(stock_entry, work_order, row, op_expense_account):
	from haloerp.stock.doctype.stock_entry.stock_entry import get_consumed_operating_cost
...
def add_operations_cost(stock_entry, work_order=None, expense_account=None, job_card=None):
	from haloerp.stock.doctype.stock_entry.stock_entry import get_remaining_operating_cost
