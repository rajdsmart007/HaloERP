...
from haloerp.stock.doctype.item.item import get_item_details
from haloerp.stock.get_item_details import get_conversion_factor, get_price_list_rate
...
from haloerp.manufacturing.doctype.bom.mapper import (
	get_bom_diff,
	get_children,
	item_query,
	make_variant_bom,
)
from haloerp.manufacturing.doctype.bom.services.costing import (
	BOMCostingService,
)
from haloerp.manufacturing.doctype.bom.services.exploded_items import (
	BOMExplodedItemsService,
)
from haloerp.manufacturing.doctype.bom.services.operations_cost import (
	add_additional_cost,
...
class BOM(WebsiteGenerator):
	...
	if TYPE_CHECKING:
		...
		from haloerp.manufacturing.doctype.bom_explosion_item.bom_explosion_item import BOMExplosionItem
		from haloerp.manufacturing.doctype.bom_item.bom_item import BOMItem
		from haloerp.manufacturing.doctype.bom_operation.bom_operation import BOMOperation
		from haloerp.manufacturing.doctype.bom_secondary_item.bom_secondary_item import BOMSecondaryItem
	...
	def company_currency(self):
		return haloerp.get_company_currency(self.company)
