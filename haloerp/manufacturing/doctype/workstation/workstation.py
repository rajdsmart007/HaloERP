...
from haloerp.support.doctype.issue.issue import get_holidays
...
class Workstation(Document):
	...
	if TYPE_CHECKING:
		...
		from haloerp.manufacturing.doctype.workstation_cost.workstation_cost import WorkstationCost
		from haloerp.manufacturing.doctype.workstation_working_hour.workstation_working_hour import (
