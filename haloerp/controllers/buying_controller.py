...
from haloerp.accounts.doctype.budget.budget import validate_expense_against_budget
from haloerp.accounts.party import _get_party_details
from haloerp.buying.utils import update_last_purchase_rate, validate_for_items
from haloerp.controllers.accounts_controller import get_taxes_and_charges
from haloerp.controllers.sales_and_purchase_return import get_rate_for_return
...
class BuyingController(SubcontractingController):
	...
	def validate_budget(self):
		if not frappe.get_single_value("Accounts Settings", "use_legacy_budget_controller"):
			from haloerp.controllers.budget_controller import BudgetValidation
