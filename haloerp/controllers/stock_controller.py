...
from haloerp.accounts.utils import cancel_exchange_gain_loss_journal
from haloerp.controllers.accounts_controller import AccountsController
from haloerp.controllers.sales_and_purchase_return import (
	available_serial_batch_for_return,
	filter_serial_batches,
	make_serial_batch_bundle_for_return,
)

# Re-exported for backward compatibility; canonical home is haloerp.exceptions.
from haloerp.exceptions import (
	BatchExpiredError,
	QualityInspectionNotSubmittedError,
	QualityInspectionRejectedError,
	QualityInspectionRequiredError,
)
from haloerp.setup.doctype.brand.brand import get_brand_defaults
from haloerp.setup.doctype.item_group.item_group import get_item_group_defaults
from haloerp.stock import get_warehouse_account, get_warehouse_account_map
from haloerp.stock.doctype.item.item import get_item_defaults
from haloerp.stock.services.internal_transfer import StockInternalTransferService
from haloerp.stock.stock_ledger import get_items_to_be_repost


class StockController(AccountsController):
	def validate(self):
		from haloerp.stock.doctype.putaway_rule.putaway_rule import validate_putaway_capacity
		from haloerp.stock.services.serial_batch_bundle_service import SerialBatchBundleService
	...
	def make_gl_entries(self, gl_entries=None, from_repost=False, via_landed_cost_voucher=False):
		...
		need_inventory_map = (self.get_stock_items() or self.get("packed_items")) and (
			cint(haloerp.is_perpetual_inventory_enabled(self.company))
		)
	...
	def get_gl_entries(
		...
		from haloerp.stock.services.base_stock_gl_composer import BaseStockGLComposer
	...
	def get_items_and_warehouses(self) -> tuple[list[str], list[str]]:
		from haloerp.stock.services.stock_ledger_service import StockLedgerService
	...
	def get_item_account_wise_lcv_entries(self):
		from haloerp.stock.doctype.landed_cost_voucher.landed_cost_voucher import (
	...
	def validate_warehouse(self):
		from haloerp.stock.utils import validate_disabled_warehouse, validate_warehouse_company
	...
	def validate_inspection(self):
		from haloerp.stock.services.quality_inspection_service import QualityInspectionService
	...
	def add_gl_entry(
		...
		from haloerp.accounts.services.base_gl_composer import add_gl_entry
...
def show_accounting_ledger_preview(company: str, doctype: str, docname: str):
	from haloerp.controllers.ledger_preview import get_accounting_ledger_preview
...
def show_stock_ledger_preview(company: str, doctype: str, docname: str):
	from haloerp.controllers.ledger_preview import get_stock_ledger_preview
...
def check_item_quality_inspection(doctype: str, docstatus: str | int, items: str | list[dict]):
	from haloerp.stock.services.quality_inspection_service import INSPECTION_FIELDNAME_MAP
...
def future_sle_exists(args, sl_entries=None):
	from haloerp.stock.utils import get_combine_datetime
...
def create_item_wise_repost_entries(
	...
	from haloerp.stock.utils import get_valuation_method
