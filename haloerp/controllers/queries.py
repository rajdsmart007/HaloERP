...
import haloerp
from haloerp.accounts.utils import build_qb_match_conditions
from haloerp.stock.doctype.company_restriction.company_restriction import get_restriction_criterion
from haloerp.stock.get_item_details import _get_item_tax_template
from haloerp.stock.utils import get_combine_datetime
from haloerp.utilities.query import get_filter_conditions_qb
...
def tax_account_query(doctype: str, txt: str, searchfield: str, start: int, page_len: int, filters: dict):
	company_currency = haloerp.get_company_currency(filters.get("company"))
