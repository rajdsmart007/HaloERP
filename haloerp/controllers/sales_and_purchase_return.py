...
from haloerp.stock.utils import get_combine_datetime, get_incoming_rate, get_valuation_method, getdate
...
def validate_quantity(doc, key, args, ref, valid_items, already_returned_items):
	...
	company_currency = haloerp.get_company_currency(doc.company)
