...
from haloerp.accounts.party import render_address
from haloerp.controllers.accounts_controller import get_taxes_and_charges
from haloerp.controllers.sales_and_purchase_return import get_rate_for_return, is_batch_expired
from haloerp.controllers.stock_controller import StockController
from haloerp.stock.doctype.item.item import set_item_default
from haloerp.stock.get_item_details import get_bin_details, get_conversion_factor
from haloerp.stock.utils import get_combine_datetime, get_incoming_rate, get_valuation_method
...
class SellingController(StockController):
	...
	def set_missing_lead_customer_details(self, for_validate=False):
		...
		if customer:
			from haloerp.accounts.party import _get_party_details
			...
			from haloerp.crm.doctype.lead.lead import get_lead_details
	...
	def set_incoming_rate(self):
		...
		from haloerp.stock.serial_batch_bundle import get_batch_nos, get_serial_nos
	...
	def validate_items(self):
		...
		from haloerp.controllers.buying_controller import validate_item_type
