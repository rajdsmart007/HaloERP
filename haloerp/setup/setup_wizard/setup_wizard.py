...
from haloerp.setup.demo import setup_demo_data
from haloerp.setup.setup_wizard.operations import install_fixtures as fixtures
...
def capture_user_persona(args):  # nosemgrep
	...
	capture("user_persona_submitted", "haloerp",
		properties={
