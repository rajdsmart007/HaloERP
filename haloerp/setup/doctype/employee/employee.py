...
from haloerp.utilities.transaction_base import delete_events
...
class Employee(NestedSet):
	...
	if TYPE_CHECKING:
		...
		from haloerp.setup.doctype.employee_education.employee_education import EmployeeEducation
		from haloerp.setup.doctype.employee_external_work_history.employee_external_work_history import (
			EmployeeExternalWorkHistory,
		)
		from haloerp.setup.doctype.employee_internal_work_history.employee_internal_work_history import (
