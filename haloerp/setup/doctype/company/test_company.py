...
from haloerp.setup.doctype.company.company import get_default_company_address
...
class TestCompany(ERPNextTestSuite):
	...
	def test_get_children_root_includes_empty_string_parent(self):
		...
		from haloerp.setup.doctype.company.company import get_children
	...
	def test_annual_transaction_history_merges_dates_across_doctypes(self):
		...
		from haloerp.setup.doctype.company.company import get_all_transactions_annual_history
	...
	def test_demo_data(self):
		from haloerp.setup.demo import clear_demo_data, setup_demo_data
