...
def setup_demo_data(company_name):
	...
	try:
		...
		capture("demo_data_creation_failed", "haloerp", properties={"exception": frappe.get_traceback()})
...
def clear_demo_data():
	...
	capture("demo_data_erased", "haloerp")
	try:
...
def make_transactions(company):
	...
	from haloerp.accounts.utils import FiscalYearError
