...
from haloerp.maintenance.doctype.maintenance_schedule.maintenance_schedule import (
...
class TestMaintenanceSchedule(ERPNextTestSuite):
	...
	def test_validate_schedule_date_skips_holiday(self):
		...
		from haloerp.setup.doctype.holiday_list.test_holiday_list import make_holiday_list
