...
def task(doc_name, from_doctype, to_doctype):
	from haloerp.accounts.doctype.payment_entry import payment_entry
	from haloerp.accounts.doctype.purchase_invoice import mapper as purchase_invoice
	from haloerp.accounts.doctype.sales_invoice import mapper as sales_invoice
	from haloerp.buying.doctype.purchase_order import mapper as purchase_order
	from haloerp.buying.doctype.supplier_quotation import mapper as supplier_quotation
	from haloerp.selling.doctype.quotation import mapper as quotation
	from haloerp.selling.doctype.sales_order import mapper as sales_order
	from haloerp.stock.doctype.delivery_note import mapper as delivery_note
	from haloerp.stock.doctype.purchase_receipt import mapper as purchase_receipt
