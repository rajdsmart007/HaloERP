...
from haloerp.accounts.report.trial_balance.trial_balance import execute
...
class TestTrialBalanceReport(ERPNextTestSuite):
	...
	def test_show_unclosed_fy_pl_balances_controls_pl_opening(self):
		...
		from haloerp.accounts.doctype.journal_entry.test_journal_entry import make_journal_entry
		from haloerp.accounts.doctype.period_closing_voucher.test_period_closing_voucher import (
			create_cost_center,
		)
