...
from haloerp.accounts.report.accounts_receivable.accounts_receivable import execute
from haloerp.accounts.test.accounts_mixin import AccountsTestMixin
...
class TestAccountsReceivable(ERPNextTestSuite, AccountsTestMixin):
	...
	def test_payment_terms_template_filters(self):
		from haloerp.controllers.accounts_controller import get_payment_terms
