...
from haloerp.accounts.doctype.sales_invoice.mapper import make_delivery_note, make_sales_return
from haloerp.accounts.doctype.sales_invoice.test_sales_invoice import create_sales_invoice
from haloerp.accounts.report.gross_profit.gross_profit import GrossProfitGenerator, execute
...
class TestGrossProfit(ERPNextTestSuite):
	...
	def test_drop_ship_return_matches_sales_invoice_item(self):
		...
		from haloerp.selling.doctype.sales_order.mapper import make_purchase_order, make_sales_invoice
		from haloerp.selling.doctype.sales_order.test_sales_order import make_sales_order
	...
	def create_drop_ship_order(self, qty=10, selling_rate=100, buying_rate=80):
		from haloerp.buying.doctype.purchase_order.mapper import make_purchase_invoice
		from haloerp.selling.doctype.sales_order.mapper import make_purchase_order
		from haloerp.selling.doctype.sales_order.test_sales_order import make_sales_order
		from haloerp.stock.doctype.item.test_item import make_item
