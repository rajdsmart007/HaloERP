...
class AccountingDimensionFilter(Document):
	...
	if TYPE_CHECKING:
		...
		from haloerp.accounts.doctype.allowed_dimension.allowed_dimension import AllowedDimension
		from haloerp.accounts.doctype.applicable_on_account.applicable_on_account import ApplicableOnAccount
