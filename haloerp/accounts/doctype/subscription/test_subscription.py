...
from haloerp.accounts.doctype.subscription.subscription import (
	Subscription,
	get_plan_dimensions,
	get_prorata_factor,
	process_all,
)
from haloerp.accounts.utils import update_subscription_on_invoice_update
...
class TestSubscription(ERPNextTestSuite):
	...
	def test_generate_invoice_at_migration_patch(self):
		from haloerp.patches.v16_0.migrate_subscription_generate_invoice_at import VALUE_MAP, execute
