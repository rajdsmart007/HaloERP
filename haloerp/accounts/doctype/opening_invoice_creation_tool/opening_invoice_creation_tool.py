...
from haloerp.stock.utils import get_default_stock_uom
...
class OpeningInvoiceCreationTool(Document):
	...
	if TYPE_CHECKING:
		...
		from haloerp.accounts.doctype.opening_invoice_creation_tool_item.opening_invoice_creation_tool_item import (
