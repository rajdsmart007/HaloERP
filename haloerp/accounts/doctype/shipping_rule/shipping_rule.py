...
class ShippingRule(Document):
	...
	if TYPE_CHECKING:
		...
		from haloerp.accounts.doctype.shipping_rule_condition.shipping_rule_condition import (
			ShippingRuleCondition,
		)
		from haloerp.accounts.doctype.shipping_rule_country.shipping_rule_country import ShippingRuleCountry
	...
	def add_shipping_rule_to_tax_table(self, doc, shipping_amount):
		...
		if not self.cost_center:
			shipping_charge_filters["cost_center"] = (
				"in",
				(None, "", haloerp.get_default_cost_center(doc.company)),
			)
