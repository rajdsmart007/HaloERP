...
class RepostAccountingLedger(Document):
	...
	if TYPE_CHECKING:
		...
		from haloerp.accounts.doctype.repost_accounting_ledger_items.repost_accounting_ledger_items import (
	...
	def generate_preview(self):
		from haloerp.accounts.report.general_ledger.general_ledger import get_columns as get_gl_columns
...
def _enqueue_repost(repost_doc_name: str) -> None:
	...
	"""
	frappe.enqueue(
		method="haloerp.accounts.doctype.repost_accounting_ledger.repost_accounting_ledger.repost",
...
def repost(repost_doc_name: str, commit: bool = True):
	...
	"""
	from haloerp.accounts.utils import _delete_accounting_ledger_entries, _delete_adv_pl_entries
