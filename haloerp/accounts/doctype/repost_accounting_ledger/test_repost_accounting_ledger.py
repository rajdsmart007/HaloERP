...
from haloerp.stock.doctype.purchase_receipt.test_purchase_receipt import get_gl_entries, make_purchase_receipt
from haloerp.tests.utils import ERPNextTestSuite

REPOST_MODULE = "haloerp.accounts.doctype.repost_accounting_ledger.repost_accounting_ledger"
...
class TestRepostAccountingLedger(ERPNextTestSuite):
	...
	def test_18_hook_allowed_doctype_repost(self):
		...
		with patch("haloerp.accounts.general_ledger.make_reverse_gl_entries") as make_reverse_gl_entries:
			_repost_allowed_hook_doctypes(doc, delete_cancelled_entries=False)
