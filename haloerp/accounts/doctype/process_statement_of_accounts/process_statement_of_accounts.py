...
from haloerp.accounts.report.accounts_receivable.accounts_receivable import execute as get_ar_soa
from haloerp.accounts.report.accounts_receivable_summary.accounts_receivable_summary import (
	execute as get_ageing,
)
from haloerp.accounts.report.general_ledger.general_ledger import execute as get_soa
from haloerp.utilities.query import get_match_conditions_qb
...
class ProcessStatementOfAccounts(Document):
	...
	if TYPE_CHECKING:
		...
		from haloerp.accounts.doctype.process_statement_of_accounts_cc.process_statement_of_accounts_cc import (
			ProcessStatementOfAccountsCC,
		)
		from haloerp.accounts.doctype.process_statement_of_accounts_customer.process_statement_of_accounts_customer import (
			ProcessStatementOfAccountsCustomer,
		)
		from haloerp.accounts.doctype.psoa_cost_center.psoa_cost_center import PSOACostCenter
		from haloerp.accounts.doctype.psoa_project.psoa_project import PSOAProject
