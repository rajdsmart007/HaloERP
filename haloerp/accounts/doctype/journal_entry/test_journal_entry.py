...
from haloerp.accounts.doctype.journal_entry.journal_entry import StockAccountInvalidTransaction
from haloerp.exceptions import InvalidAccountCurrency
from haloerp.selling.doctype.customer.test_customer import make_customer, set_credit_limit
...
class TestJournalEntry(ERPNextTestSuite):
	...
	def test_reverse_journal_entry(self):
		from haloerp.accounts.doctype.journal_entry.mapper import make_reverse_journal_entry
	...
	def test_negative_debit_and_credit_with_same_account_head(self):
		from haloerp.accounts.general_ledger import process_gl_map
	...
	def test_get_payment_entry_against_order_builds_advance_je(self):
		...
		from haloerp.accounts.doctype.journal_entry.mapper import get_payment_entry_against_order
		from haloerp.selling.doctype.sales_order.test_sales_order import make_sales_order
	...
	def test_make_inter_company_journal_entry_builds_linked_draft(self):
		...
		from haloerp.accounts.doctype.journal_entry.mapper import make_inter_company_journal_entry
