...
from haloerp.accounts.doctype.bank_account.bank_account import get_party_bank_account
from haloerp.accounts.doctype.payment_entry.payment_entry import (
	get_payment_entry,
)
from haloerp.accounts.doctype.subscription_plan.subscription_plan import get_plan_rate
from haloerp.accounts.party import get_party_account
from haloerp.accounts.utils import get_account_currency, get_advance_payment_doctypes, get_currency_precision
from haloerp.utilities import payment_app_import_guard
...
class PaymentRequest(Document):
	...
	if TYPE_CHECKING:
		...
		from haloerp.accounts.doctype.payment_reference.payment_reference import PaymentReference
		from haloerp.accounts.doctype.subscription_plan_detail.subscription_plan_detail import (
