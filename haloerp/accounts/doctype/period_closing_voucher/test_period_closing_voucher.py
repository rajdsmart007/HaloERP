...
from haloerp.accounts.doctype.finance_book.test_finance_book import create_finance_book
...
from haloerp.accounts.general_ledger import make_reverse_gl_entries
...
class TestPeriodClosingVoucher(ERPNextTestSuite):
	...
	def test_dimension_grouped_opening_balance_matches_gl_scan(self):
		...
		from haloerp.accounts.report.balance_sheet.balance_sheet import execute
		from haloerp.accounts.report.financial_statements import build_period_list
	...
	def test_stock_validations_before_period_closing(self):
		...
		with patch("haloerp.stock.doctype.stock_closing_entry.stock_closing_entry.enqueue"):
			sce.submit()
