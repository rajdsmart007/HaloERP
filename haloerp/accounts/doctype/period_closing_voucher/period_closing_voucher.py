...
from haloerp.accounts.doctype.account_closing_balance.account_closing_balance import (
	make_closing_entries,
)
from haloerp.accounts.doctype.accounting_dimension.accounting_dimension import (
	get_accounting_dimensions,
)
from haloerp.accounts.general_ledger import check_freezing_date, is_immutable_ledger_enabled
from haloerp.accounts.utils import get_account_currency, get_fiscal_year
from haloerp.controllers.accounts_controller import AccountsController
from haloerp.stock.doctype.stock_closing_entry.stock_closing_entry import apply_unscoped_filters
from haloerp.stock.utils import get_stock_value_on
