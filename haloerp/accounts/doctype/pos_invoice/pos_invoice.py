...
from haloerp.accounts.doctype.sales_invoice.sales_invoice import (
	SalesInvoice,
	get_mode_of_payment_info,
	update_multi_mode_option,
)
from haloerp.accounts.doctype.sales_invoice.services.loyalty import LoyaltyService
from haloerp.accounts.party import get_due_date, get_party_account
from haloerp.controllers.queries import item_query as _item_query
from haloerp.controllers.sales_and_purchase_return import get_sales_invoice_item_from_consolidated_invoice
...
from haloerp.stock.stock_ledger import is_negative_stock_allowed
...
class POSInvoice(SalesInvoice):
	...
	if TYPE_CHECKING:
		...
		from haloerp.accounts.doctype.pos_invoice_item.pos_invoice_item import POSInvoiceItem
	...
	def validate(self):
		...
		if self.coupon_code:
			from haloerp.accounts.doctype.pricing_rule.utils import validate_coupon_code
	...
	def on_submit(self):
		...
		if self.coupon_code:
			from haloerp.accounts.doctype.pricing_rule.utils import update_coupon_code_count
...
def create_payments_on_invoice(doc, idx, payment_details):
	from haloerp.accounts.doctype.sales_invoice.sales_invoice import get_bank_cash_account
