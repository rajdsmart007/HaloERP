...
from haloerp.accounts.doctype.purchase_invoice.services.billing_status import BillingStatusService
from haloerp.accounts.doctype.purchase_invoice.services.expense_account import ExpenseAccountService
...
from haloerp.accounts.doctype.tax_withholding_entry.tax_withholding_entry import PurchaseTaxWithholding
from haloerp.accounts.general_ledger import (
...
from haloerp.assets.doctype.asset.asset import is_cwip_accounting_enabled
from haloerp.controllers.buying_controller import BuyingController
...
class PurchaseInvoice(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from haloerp.accounts.doctype.purchase_invoice_advance.purchase_invoice_advance import (
			PurchaseInvoiceAdvance,
		)
		from haloerp.accounts.doctype.purchase_invoice_item.purchase_invoice_item import PurchaseInvoiceItem
		from haloerp.accounts.doctype.purchase_taxes_and_charges.purchase_taxes_and_charges import (
			PurchaseTaxesandCharges,
		)
		from haloerp.accounts.doctype.tax_withholding_entry.tax_withholding_entry import TaxWithholdingEntry
		from haloerp.buying.doctype.purchase_receipt_item_supplied.purchase_receipt_item_supplied import (
	...
	def validate_exchange_rate_with_purchase_receipt(self):
		if self.is_internal_transfer() or not haloerp.is_perpetual_inventory_enabled(self.company):
			return
	...
	def get_gl_entries(self, inventory_account_map=None):
		from haloerp.accounts.doctype.purchase_invoice.services.gl_composer import (
