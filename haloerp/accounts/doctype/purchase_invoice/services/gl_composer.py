...
class PurchaseInvoiceGLComposer(BaseGLComposer):
	...
	def compose(self, inventory_account_map=None):
		from haloerp.accounts.doctype.purchase_invoice.purchase_invoice import make_regional_gl_entries
		from haloerp.accounts.general_ledger import merge_similar_entries

		doc = self.doc
		doc.auto_accounting_for_stock = haloerp.is_perpetual_inventory_enabled(doc.company)
