...
frappe.provide("haloerp.cheque_print");
		...
		if (!frm.doc.__islocal) {
			if (frappe.user.has_role("System Manager")) {
				frm.add_custom_button(
					...
					function () {
						haloerp.cheque_print.view_cheque_print(frm);
					}
...
haloerp.cheque_print.view_cheque_print = function (frm) {
	frappe.call({
		method: "haloerp.accounts.doctype.cheque_print_template.cheque_print_template.create_or_update_cheque_print_format",
		args: {
