...
import haloerp
from haloerp.accounts.doctype.accounting_dimension.accounting_dimension import get_dimensions
from haloerp.accounts.doctype.bank_account.bank_account import (
...
from haloerp.accounts.doctype.journal_entry.journal_entry import get_default_bank_cash_account
from haloerp.accounts.doctype.repost_accounting_ledger.repost_accounting_ledger import (
	validate_docs_for_deferred_accounting,
	validate_docs_for_voucher_types,
)
from haloerp.accounts.doctype.tax_withholding_entry.tax_withholding_entry import PaymentTaxWithholding
...
from haloerp.controllers.accounts_controller import (
	AccountsController,
...
class PaymentEntry(AccountsController):
	...
	if TYPE_CHECKING:
		...
		from haloerp.accounts.doctype.advance_taxes_and_charges.advance_taxes_and_charges import (
			AdvanceTaxesandCharges,
		)
		from haloerp.accounts.doctype.payment_entry_deduction.payment_entry_deduction import (
			PaymentEntryDeduction,
		)
		from haloerp.accounts.doctype.payment_entry_reference.payment_entry_reference import (
	...
	def update_payment_requests(self, cancel=False):
		from haloerp.accounts.doctype.payment_request.payment_request import (
	...
	def set_transaction_currency_and_rate(self):
		company_currency = haloerp.get_company_currency(self.company)
	...
	def build_gl_map(self):
		from haloerp.accounts.doctype.payment_entry.services.gl_composer import PaymentEntryGLComposer
...
def get_reference_details(
	...
	company_currency = ref_doc.get("company_currency") or haloerp.get_company_currency(ref_doc.company)
