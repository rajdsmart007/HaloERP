...
class LoyaltyService:
	...
	def apply_loyalty_points(self) -> None:
		from haloerp.accounts.doctype.loyalty_point_entry.loyalty_point_entry import (
...
def get_loyalty_programs(customer: str) -> list:
	...
	from haloerp.selling.doctype.customer.customer import get_loyalty_programs as _get
