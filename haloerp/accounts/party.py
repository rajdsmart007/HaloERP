...
from haloerp.exceptions import InvalidAccountCurrency, PartyDisabled, PartyFrozen
...
def complete_contact_details(party_details):
	...
	if party_details.party_type == "Employee":
		from haloerp.setup.doctype.employee.employee import _get_contact_details as get_employee_contact
...
def set_taxes(
	...
	from haloerp.accounts.doctype.tax_rule.tax_rule import get_party_details, get_tax_template
