...
from haloerp.accounts.doctype.accounting_dimension.accounting_dimension import get_accounting_dimensions
from haloerp.buying.utils import update_last_purchase_rate
...
class ChildItemUpdater:
	...
	def update(self, trans_items: str | list) -> None:
		...
		from haloerp.buying.doctype.supplier_quotation.supplier_quotation import get_purchased_items
		from haloerp.selling.doctype.quotation.mapper import get_ordered_items
...
def set_order_defaults(
	...
	from haloerp.accounts.services.taxes import add_taxes_from_tax_template, set_child_tax_template_and_map
...
def update_bin_on_delete(row, doctype: str) -> None:
	...
	from haloerp.stock.stock_balance import (
		get_indented_qty,
		get_ordered_qty,
		get_reserved_qty,
		update_bin_qty,
