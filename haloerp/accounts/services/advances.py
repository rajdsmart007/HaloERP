...
from haloerp.accounts.utils import get_account_currency, get_advance_payment_doctypes
...
def create_advance_and_reconcile(doc, party_link) -> None:
	...
	default_currency = haloerp.get_company_currency(doc.company)
	...
	reconcilation_entry.cost_center = doc.cost_center or haloerp.get_default_cost_center(doc.company)

	advance_entry.account = primary_account
	advance_entry.party_type = primary_party_type
	advance_entry.party = primary_party
	advance_entry.cost_center = doc.cost_center or haloerp.get_default_cost_center(doc.company)
