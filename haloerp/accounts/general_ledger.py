...
from haloerp.accounts.doctype.accounting_dimension_filter.accounting_dimension_filter import (
	get_dimension_filter_map,
)
from haloerp.accounts.doctype.budget.budget import validate_expense_against_budget
from haloerp.accounts.services.gl_validator import (
	check_freezing_date,
...
from haloerp.accounts.utils import create_payment_ledger_entry, is_immutable_ledger_enabled
...
def merge_similar_entries(gl_map, precision=None):
	...
	company = gl_map[0].company if gl_map else haloerp.get_default_company()
