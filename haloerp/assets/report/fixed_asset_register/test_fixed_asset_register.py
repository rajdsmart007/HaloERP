...
from haloerp.assets.doctype.asset.test_asset import AssetSetup, create_asset
...
from haloerp.assets.report.fixed_asset_register.fixed_asset_register import execute
