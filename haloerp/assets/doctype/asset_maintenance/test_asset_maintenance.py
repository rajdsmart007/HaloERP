...
from haloerp.assets.doctype.asset_maintenance.asset_maintenance import calculate_next_due_date
...
class TestAssetMaintenance(ERPNextTestSuite):
	...
	def test_get_maintenance_log_counts_by_status(self):
		...
		from haloerp.assets.doctype.asset_maintenance.asset_maintenance import get_maintenance_log
