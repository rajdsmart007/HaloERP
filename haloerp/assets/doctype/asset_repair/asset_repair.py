...
class AssetRepair(AccountsController):
	...
	if TYPE_CHECKING:
		...
		from haloerp.assets.doctype.asset_repair_consumed_item.asset_repair_consumed_item import (
			AssetRepairConsumedItem,
		)
		from haloerp.assets.doctype.asset_repair_purchase_invoice.asset_repair_purchase_invoice import (
	...
	def get_gl_entries(self):
		from haloerp.assets.doctype.asset_repair.services.gl_composer import AssetRepairGLComposer
