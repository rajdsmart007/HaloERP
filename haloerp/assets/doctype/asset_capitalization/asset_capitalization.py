...
import haloerp
from haloerp.assets.doctype.asset.asset import get_asset_value_after_depreciation
from haloerp.assets.doctype.asset.depreciation import (
	get_value_after_depreciation_on_disposal_date,
	reset_depreciation_schedule,
	reverse_depreciation_entry_made_on_disposal,
)
from haloerp.assets.doctype.asset_activity.asset_activity import add_asset_activity
...
class AssetCapitalization(StockController):
	...
	if TYPE_CHECKING:
		...
		from haloerp.assets.doctype.asset_capitalization_asset_item.asset_capitalization_asset_item import (
			AssetCapitalizationAssetItem,
		)
		from haloerp.assets.doctype.asset_capitalization_service_item.asset_capitalization_service_item import (
			AssetCapitalizationServiceItem,
		)
		from haloerp.assets.doctype.asset_capitalization_stock_item.asset_capitalization_stock_item import (
	...
	def get_gl_entries(
		...
		from haloerp.assets.doctype.asset_capitalization.services.gl_composer import (
