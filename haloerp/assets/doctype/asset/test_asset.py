...
from haloerp.assets.doctype.asset.asset import (
...
from haloerp.assets.doctype.asset.mapper import (
	make_sales_invoice,
	split_asset,
)
...
class TestDepreciationBasics(AssetSetup):
	...
	def test_depr_schedule_link_matches_at_currency_precision(self):
		...
		from haloerp.accounts.doctype.journal_entry.services import asset_service as asset_service_module
	...
	def test_split_asset_created_via_capitalization(self):
		...
		from haloerp.assets.doctype.asset_capitalization.test_asset_capitalization import (
