...
class Asset(AccountsController):
	...
	if TYPE_CHECKING:
		...
		from haloerp.assets.doctype.asset_finance_book.asset_finance_book import AssetFinanceBook
	...
	def get_default_finance_book_idx(self):
		if not self.get("default_finance_book") and self.company:
			self.default_finance_book = haloerp.get_default_finance_book(self.company)
