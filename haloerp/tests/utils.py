...
class BootStrapTestData:
	...
	def make_presets(self):
		...
		from haloerp.setup.setup_wizard.operations.install_fixtures import (
			add_uom_data,
			get_preset_records,
			get_sale_stages,
		)
		...
		from haloerp.setup.setup_wizard.operations.install_fixtures import read_lines
		...
		from haloerp.buying.doctype.supplier_scorecard.supplier_scorecard import (
...
class HaloERPTestSuite(unittest.TestCase):
	@classmethod
