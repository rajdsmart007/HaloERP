...
class Supplier(TransactionBase):
	...
	if TYPE_CHECKING:
		...
		from haloerp.buying.doctype.customer_number_at_supplier.customer_number_at_supplier import (
	...
	def create_primary_contact(self):
		from haloerp.selling.doctype.customer.mapper import make_contact
	...
	def create_primary_address(self):
		...
		from haloerp.selling.doctype.customer.mapper import make_address
