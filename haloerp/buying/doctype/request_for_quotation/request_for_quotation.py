...
class RequestforQuotation(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from haloerp.buying.doctype.request_for_quotation_item.request_for_quotation_item import (
			RequestforQuotationItem,
		)
		from haloerp.buying.doctype.request_for_quotation_supplier.request_for_quotation_supplier import (
