...
from haloerp.projects.doctype.project_template.test_project_template import make_project_template
from haloerp.projects.doctype.task.test_task import create_task
from haloerp.selling.doctype.sales_order.mapper import make_project as make_project_from_so
...
class TestProject(ERPNextTestSuite):
	def test_get_timeline_data_runs(self):
		...
		from haloerp.projects.doctype.project.project import get_timeline_data
		from haloerp.projects.doctype.timesheet.test_timesheet import make_timesheet
	...
	def test_create_duplicate_project_copies_tasks(self):
		from haloerp.projects.doctype.project.project import create_duplicate_project
	...
	def test_set_project_status_updates_project_and_tasks(self):
		from haloerp.projects.doctype.project.project import set_project_status
	...
	def test_costing_rollup_from_sales_documents(self):
		...
		from haloerp.projects.doctype.project.project import update_costing_and_billing
		from haloerp.selling.doctype.sales_order.test_sales_order import make_sales_order
