...
from haloerp import get_default_company
from haloerp.controllers.website_list_for_contact import get_customers_suppliers
from haloerp.setup.doctype.holiday_list.holiday_list import is_holiday
...
class Project(Document):
	...
	if TYPE_CHECKING:
		...
		from haloerp.projects.doctype.project_user.project_user import ProjectUser
