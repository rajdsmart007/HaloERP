...
from haloerp.projects.doctype.task.task import CircularReferenceError, ParentIsGroupError
...
class TestTask(ERPNextTestSuite):
	...
	def test_overdue(self):
		...
		from haloerp.projects.doctype.task.task import set_tasks_as_overdue
	...
	def test_set_multiple_status(self):
		from haloerp.projects.doctype.task.task import set_multiple_status
	...
	def test_add_multiple_tasks_under_parent(self):
		from haloerp.projects.doctype.task.task import add_multiple_tasks
