...
from haloerp.projects.doctype.timesheet.timesheet import OverlapError, make_sales_invoice
...
class TestTimesheet(ERPNextTestSuite):
	...
	def test_get_timesheets_list_portal_sales_invoice(self):
		...
		from haloerp.projects.doctype.timesheet.timesheet import get_timesheets_list
	...
	def test_get_activity_cost_falls_back_to_activity_type(self):
		from haloerp.projects.doctype.timesheet.timesheet import get_activity_cost
	...
	def test_billing_helpers_for_timesheet_detail(self):
		from haloerp.projects.doctype.timesheet.timesheet import (
			get_timesheet_data,
