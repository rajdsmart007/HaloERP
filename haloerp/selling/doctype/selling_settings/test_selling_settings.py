...
class TestSellingSettings(ERPNextTestSuite):
	...
	def test_unrelated_change_does_not_update_customer_metadata(self):
		...
		with patch("haloerp.utilities.naming.set_by_naming_series") as set_by_naming_series:
			settings.save()
	...
	def test_unrelated_change_does_not_rewrite_toggle_setters(self):
		...
		with patch(
			"haloerp.selling.doctype.selling_settings.selling_settings.make_property_setter"
