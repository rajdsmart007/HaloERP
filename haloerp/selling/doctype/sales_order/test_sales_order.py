...
from haloerp.accounts.party import get_party_details
from haloerp.controllers.accounts_controller import InvalidQtyError, get_due_date, update_child_qty_rate
from haloerp.maintenance.doctype.maintenance_schedule.test_maintenance_schedule import (
	make_maintenance_schedule,
)
from haloerp.maintenance.doctype.maintenance_visit.test_maintenance_visit import (
	make_maintenance_visit,
)
from haloerp.manufacturing.doctype.blanket_order.test_blanket_order import make_blanket_order
from haloerp.selling.doctype.product_bundle.test_product_bundle import make_product_bundle
from haloerp.selling.doctype.sales_order.mapper import (
	create_pick_list,
	make_delivery_note,
...
from haloerp.selling.doctype.sales_order.sales_order import (
	WarehouseRequired,
)
...
from haloerp.stock.get_item_details import get_bin_details
...
class TestSalesOrder(ERPNextTestSuite):
	...
	def test_make_sales_invoice_after_return_and_redelivery(self):
		from haloerp.stock.doctype.delivery_note.mapper import make_sales_return
	...
	def test_drop_shipping(self):
		from haloerp.buying.doctype.purchase_order.purchase_order import update_status
		from haloerp.selling.doctype.sales_order.sales_order import update_status as so_update_status
	...
	def test_product_bundles_in_so_are_replaced_with_bundle_items_in_po(self):
		...
		from haloerp.selling.doctype.product_bundle.product_bundle import get_active_product_bundle
	...
	def test_make_work_order(self):
		from haloerp.selling.doctype.sales_order.sales_order import get_work_order_items
	...
	def test_work_order_pop_up_from_sales_order(self):
		...
		from haloerp.controllers.item_variant import create_variant
		from haloerp.manufacturing.doctype.production_plan.test_production_plan import make_bom
		from haloerp.selling.doctype.sales_order.sales_order import get_work_order_items
	...
	def test_so_back_updated_from_wo_via_mr(self):
		...
		from haloerp.stock.doctype.material_request.material_request import raise_work_orders
	...
	def test_sales_order_with_shipping_rule_without_cost_center(self):
		from haloerp import get_default_cost_center
	...
	@patch(
		...
		"haloerp.accounts.doctype.payment_request.payment_request.PaymentRequest.get_payment_url",
		return_value=None,
	)
	def test_sales_order_advance_payment_status(self, mocked_get_payment_url):
		from haloerp.accounts.doctype.payment_entry.test_payment_entry import get_payment_entry
		from haloerp.accounts.doctype.payment_request.payment_request import make_payment_request
	...
	def test_pick_list_for_batch(self):
		from haloerp.stock.doctype.pick_list.mapper import create_delivery_note
	...
	def test_product_bundle_reservation(self):
		...
		from haloerp.stock.doctype.stock_reservation_entry.stock_reservation_entry import (
		...
		from haloerp.stock.serial_batch_bundle import get_batches_from_bundle, get_serial_nos
	...
	def test_commission_rate_carried_through_mapper(self):
		...
		from haloerp.selling.doctype.sales_order.mapper import make_delivery_note, make_sales_invoice
