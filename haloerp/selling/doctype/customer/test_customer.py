...
from haloerp.accounts.party import get_due_date
from haloerp.exceptions import PartyDisabled, PartyFrozen
from haloerp.selling.doctype.customer.customer import (
	get_credit_limit,
	get_customer_outstanding,
	get_customer_overdue_amount,
	get_overdue_billing_threshold,
)
from haloerp.selling.doctype.customer.mapper import (
	make_quotation,
	parse_full_name,
)
...
class TestCustomer(ERPNextTestSuite):
	...
	def test_customer_credit_limit_after_submit(self):
		from haloerp.controllers.accounts_controller import update_child_qty_rate
		from haloerp.selling.doctype.sales_order.test_sales_order import make_sales_order
