...
class TestProductBundle(ERPNextTestSuite):
	...
	def test_new_bundle_from_scratch_supersedes_existing(self):
		...
		from haloerp.selling.doctype.product_bundle.product_bundle import get_new_item_code
	...
	def test_item_where_used_report_shows_disabled_flag(self):
		from haloerp.stock.report.item_where_used.item_where_used import execute
	...
	def test_item_where_used_report_hides_false_check_columns(self):
		from haloerp.stock.report.item_where_used.item_where_used import get_columns
