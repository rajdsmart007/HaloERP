...
class Quotation(SellingController):
	...
	if TYPE_CHECKING:
		...
		from haloerp.crm.doctype.competitor_detail.competitor_detail import CompetitorDetail
		from haloerp.selling.doctype.quotation_item.quotation_item import QuotationItem
		from haloerp.setup.doctype.quotation_lost_reason_detail.quotation_lost_reason_detail import (
	...
	def carry_forward_communication(self):
		from haloerp.crm.utils import copy_comments, link_communications
