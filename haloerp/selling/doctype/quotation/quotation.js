...
haloerp.accounts.taxes.setup_tax_validations("Sales Taxes and Charges Template");
haloerp.accounts.taxes.setup_tax_filters("Sales Taxes and Charges");
haloerp.pre_sales.set_as_lost("Quotation");
...
haloerp.selling.QuotationController = class QuotationController extends haloerp.selling.SellingController {
	onload(doc, dt, dn) {
	...
	set_dynamic_field_label() {
		if (this.frm.doc.quotation_to == "Customer") {
			...
			this.frm.fields_dict.party_name.get_query = haloerp.queries.customer;
		} else if (this.frm.doc.quotation_to == "Lead") {
			this.frm.set_df_property("party_name", "label", "Lead");
			this.frm.fields_dict.party_name.get_query = function () {
				return { query: "haloerp.controllers.queries.lead_query" };
			};
	...
	get_lead_details() {
		...
		frappe.call({
			method: "haloerp.crm.doctype.lead.lead.get_lead_details",
			args: {
...
cur_frm.script_manager.make(haloerp.selling.QuotationController);
