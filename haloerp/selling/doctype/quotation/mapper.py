...
def create_customer_from_lead(lead_name, ignore_permissions=False):
	from haloerp.crm.doctype.lead.mapper import _make_customer
...
def create_customer_from_prospect(prospect_name, ignore_permissions=False):
	from haloerp.crm.doctype.prospect.prospect import make_customer as make_customer_from_prospect
