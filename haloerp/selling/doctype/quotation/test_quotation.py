...
from haloerp.selling.doctype.quotation.mapper import make_sales_order
...
class TestQuotation(ERPNextTestSuite):
	...
	def test_gross_profit(self):
		...
		from haloerp.stock.get_item_details import insert_item_price
	...
	def test_quotation_expiry(self):
		from haloerp.selling.doctype.quotation.quotation import set_expired_status
