...
from haloerp.selling.report.sales_partner_commission_summary.sales_partner_commission_summary import (
	SALES_TRANSACTION_DOCTYPES,
)
from haloerp.selling.report.sales_partner_transaction_summary.test_utils import (
...
class SalesPartnerSummaryReportTestMixin(ERPNextTestSuite):
	...
	def create_transactions(self, doctype):
		from haloerp.accounts.doctype.pos_invoice.test_pos_invoice import (
			POSInvoiceTestMixin,
			create_pos_invoice,
		)
