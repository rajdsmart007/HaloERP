...
from haloerp.selling.doctype.product_bundle.product_bundle import NAME_PREFIX, build_bundle_name
...
def _next_index(item_code: str) -> int:
	...
	from haloerp.selling.doctype.product_bundle.product_bundle import get_next_version_index
