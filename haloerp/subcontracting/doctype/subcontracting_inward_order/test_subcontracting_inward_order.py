...
from haloerp.manufacturing.doctype.work_order.mapper import make_stock_entry as make_stock_entry_from_wo
from haloerp.selling.doctype.sales_order.mapper import make_subcontracting_inward_order
...
class IntegrationTestSubcontractingInwardOrder(ERPNextTestSuite):
	...
	def test_subcontracting_delivery(self):
		from haloerp.stock.serial_batch_bundle import get_serial_batch_list_from_item
...
def make_service_items():
	from haloerp.controllers.tests.test_subcontracting_controller import make_service_item
