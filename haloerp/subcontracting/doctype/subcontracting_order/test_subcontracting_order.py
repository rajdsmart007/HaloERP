...
from haloerp.buying.doctype.purchase_order.mapper import get_mapped_subcontracting_order
...
class TestSubcontractingOrder(ERPNextTestSuite):
	...
	def test_stock_reservation_transfer(self):
		...
		from haloerp.manufacturing.doctype.production_plan.test_production_plan import create_production_plan
		from haloerp.stock.doctype.stock_reservation_entry.stock_reservation_entry import (
