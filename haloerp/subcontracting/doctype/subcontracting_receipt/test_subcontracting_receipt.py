...
from haloerp.subcontracting.doctype.subcontracting_receipt.subcontracting_receipt import (
	BOMQuantityError,
)
...
class TestSubcontractingReceipt(ERPNextTestSuite):
	...
	def test_subcontracting_over_receipt(self):
		...
		"""
		from haloerp.controllers.subcontracting_controller import (
	...
	def test_subcontracting_receipt_gl_entry(self):
		...
		self.assertEqual(cint(haloerp.is_perpetual_inventory_enabled(scr.company)), 1)
	...
	def test_inventory_dimensions(self):
		...
		"""
		from haloerp.stock.doctype.inventory_dimension.test_inventory_dimension import (
