...
import haloerp
from haloerp.controllers.subcontracting_controller import SubcontractingController
...
from haloerp.stock.get_item_details import get_default_cost_center, get_default_expense_account
from haloerp.stock.stock_ledger import get_valuation_rate
...
class SubcontractingReceipt(SubcontractingController):
	...
	if TYPE_CHECKING:
		...
		from haloerp.subcontracting.doctype.subcontracting_receipt_item.subcontracting_receipt_item import (
			SubcontractingReceiptItem,
		)
		from haloerp.subcontracting.doctype.subcontracting_receipt_supplied_item.subcontracting_receipt_supplied_item import (
	...
	def get_gl_entries(self, inventory_account_map=None):
		from haloerp.subcontracting.doctype.subcontracting_receipt.services.gl_composer import (
